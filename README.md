...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/soft-unit-bfa3)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/soft-unit-bfa3
```

A live public deployment of this template is available at [https://soft-unit-bfa3.templates.workers.dev](https://soft-unit-bfa3.templates.workers.dev)
